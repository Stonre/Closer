...
class CircleTableViewController: UITableViewController {
    ...
    private func searchForActivities() {
        ...
        for i in 1...10 {
            defaultSection.append(GeneralActivity(name: "Activity \(i)", tags: [], authority: Authority.FriendsAndContacts, description: Description(txt: "This is Activity \(i)"), userReleasing: PersonalUserForView(userName: "User \(i)", userId: 0, gender: Gender.Female, age: 18)))
        }
...
//    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CircleTableCell", for: indexPath)
